...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  SendRpResp SendRp(SendRpReq req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := rpc.NewRedPacketServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "SendRp":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "SendRp requires 1 args")
			flag.Usage()
		}
		arg6 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.SendRp(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
